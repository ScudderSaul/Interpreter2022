...
// containing all primitive calls

#ifdef FORTHDLL
class CLASS_DECLSPEC InterpreterData
#else
...
#endif
{
  ...
  Dictonary * dictonary;   // the dictionary
...
#ifdef FORTHDLL
class CLASS_DECLSPEC Primitives
#else
class Primitives
#endif
{
...
// The parser class with a stack of current parsing
